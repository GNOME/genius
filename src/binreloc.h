...
/* Mangle symbol names to avoid symbol collisions with other ELF objects. */
	#define gbr_find_exe         Ygij42563549884387_gbr_find_exe
	#define gbr_find_exe_dir     Ygij42563549884387_gbr_find_exe_dir
	#define gbr_find_prefix      Ygij42563549884387_gbr_find_prefix
	#define gbr_find_bin_dir     Ygij42563549884387_gbr_find_bin_dir
	#define gbr_find_sbin_dir    Ygij42563549884387_gbr_find_sbin_dir
	#define gbr_find_data_dir    Ygij42563549884387_gbr_find_data_dir
	#define gbr_find_locale_dir  Ygij42563549884387_gbr_find_locale_dir
	#define gbr_find_lib_dir     Ygij42563549884387_gbr_find_lib_dir
	#define gbr_find_libexec_dir Ygij42563549884387_gbr_find_libexec_dir
	#define gbr_find_etc_dir     Ygij42563549884387_gbr_find_etc_dir
