...
typedef struct _GtkPlotCanvasPolygon	GtkPlotCanvasPolygon;
...
void gtk_plot_canvas_ellipse_set_attributes	(GtkPlotCanvasChild *child,
                                       		...
                                       		const GdkColor *bg,
                                       		gboolean fill);
void gtk_plot_canvas_polygon_set_attributes	(GtkPlotCanvasChild *child,
                                       		GtkPlotLineStyle style,
                                       		gfloat width,
                                       		const GdkColor *fg,
                                       		const GdkColor *bg,
...
gboolean	gtk_plot_canvas_get_child_position	(GtkPlotCanvas *canvas,
						GtkPlotCanvasChild *child,
						double *x1, double *y1,
						double *x2, double *y2);

gpointer	gtk_plot_canvas_get_child_data	(GtkPlotCanvasChild *child);
