...
char *fake = N_("Tolerance for AdaptiveGaussKronrodAbsoluteTolerance");
char *fake = N_("Maximum number of iterations to Tolerance to perform in NumericalIntegral");
char *fake = N_("Tolerance for AdaptiveGaussKronrodRelativeTolerance");
...
char *fake = N_("The function used for numerical integration in NumericalIntegral (by default AdaptiveGaussKronrod)");
...
char *fake = N_("Use adaptive composite Gauss-Kronrod (K15, G7) rule until error estimate is less than AdaptiveGaussKronrodAbsoluteTolerance and AdaptiveGaussKronrodRelativeTolerance up to AdaptiveGaussKronrodMaxIterations times, if unsuccessful returns null");
...
char *fake = N_("Return the result of a single GaussKronrodRule (K15, G7), returns a vector with the estimate and the error estimate");
...
char *fake = N_("Integration by rule set in NumericalIntegralFunction of f from a to b");
