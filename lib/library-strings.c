...
char *fake = N_("Absolute tolerance for AdaptiveGaussKronrod, error should be less than this");
char *fake = N_("Maximum number of iterations to perform in AdaptiveGaussKronrod");
char *fake = N_("Relative tolerance for AdaptiveGaussKronrod, error should be less than this times the estimated value");
...
char *fake = N_("Default number of steps to perform in MidpointRule, TrapezoidRule, LeftHandRule, RightHandRule, and CompositeSimpsonsRule");
